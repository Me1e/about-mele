(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      objs: {
        ...
        canvasCaption: document.querySelector(
          "#scroll-section-1 .canvas-caption"
        ),
        canvas: document.querySelector("#scroll-section-1 .image-blend-canvas"),
        context: document
          .querySelector("#scroll-section-1 .image-blend-canvas")
          .getContext("2d"),
    ...
    },
    {
      ...
      objs: {
        ...
        canvasCaption: document.querySelector(
          "#scroll-section-2 .canvas-caption"
        ),
        canvas: document.querySelector("#scroll-section-2 .image-blend-canvas"),
        context: document
          .querySelector("#scroll-section-2 .image-blend-canvas")
          .getContext("2d"),
        imagesPath: ["./2/design_m.jpg", "./2/design.jpg"],
        images: [],
      },
      values: {
        rect1X: [0, 0, { start: 0, end: 0 }],
    ...
    },
    {
      ...
      objs: {
        ...
        context: document
          ...
          .getContext("2d"),
        imagesPath: ["./2/jbnu_m.jpg", "./2/jbnu.jpg"],
        images: [],
      },
      values: {
        rect1X: [0, 0, { start: 0, end: 0 }],
  ...
  function setCanvasImages() {
    ...
    for (let i = 1; i < sceneInfo[0].values.videoImageCount + 1; i++) {
      imgElem = new Image();
      imgElem.src = `./1/thumb${i.toString().padStart(4, "0")}.jpg`;
  ...
  function setLayout() {
    ...
    let selectedRatio = heightRatio * 0.6;
    if (widthRatio < 0.35) {
      selectedRatio = widthRatio * 0.8;
    }
    sceneInfo[0].objs.canvas.style.transform = `translate3d(-50%, -50%, 0) scale(${selectedRatio})`;
  }
        ...
        (() => {
          ...
          if (scrollRatio < values.rect1X[2].end) {
            ...
            if (
              ...
              objs.canvasCaption.style.opacity =
  ...
  window.addEventListener("load", () => {
    ...
    for (let i = 0; i < sceneInfo[2].objs.imagesPath.length; i++) {
      imgElem = new Image();
      imgElem.src = sceneInfo[2].objs.imagesPath[i];
      sceneInfo[2].objs.images.push(imgElem);
    }
